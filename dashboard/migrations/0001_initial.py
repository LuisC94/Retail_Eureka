# Generated by Django 5.2.7 on 2025-11-27 00:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_area_ha', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Área total do pomar (ha)')),
                ...
                ('density_plants_ha', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Densidade de plantação (plantas/ha)')),
