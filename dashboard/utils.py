...
def create_genesis_dossier(harvest):
    ...
    Reutilizável para chamadas manuais ou automáticas para a Blockchain Real (Hyperledger Fabric).
    """
    ...
    dossier = {
        ...
        "harvest": {
            ...
            "firmness": float(harvest.firmness) if hasattr(harvest, 'firmness') and harvest.firmness is not None else "N/A",
            "acidity": float(harvest.acidity) if hasattr(harvest, 'acidity') and harvest.acidity is not None else "N/A"
        },
