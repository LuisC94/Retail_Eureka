...
class ParallelPPOAgent:
    ...
    def update(self):
        ...
        # Se o buffer tiver um estado a mais, usamos para bootstrapping (Cenário B)
        ...
        # Se tivermos um estado a mais (bootstrapping), ignoramos o último para o treino direto
    ...
    def save(self, checkpoint_path):
        ...
        # Guardar também o estado do reward_scaler
        scaler_state = {
    ...
    def load(self, checkpoint_path):
        import os
        # 1. Carregar os pesos brilhantes nas redes ATIVAS primárias
        ...
        # 2. Sincronizar as redes do passado para começarem com a mesma inteligência
        self.policy_old_actor.load_state_dict(self.policy_actor.state_dict())
        self.policy_old_critic.load_state_dict(self.policy_critic.state_dict())
        
        # 3. Carregar o reward_scaler se o ficheiro existir
